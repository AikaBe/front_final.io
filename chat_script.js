document.addEventListener("DOMContentLoaded", function () {
  ...
  function setTheme(theme) {
    if (theme === "dark") {
      ...
      themeIcon.src =
        "https://i.pinimg.com/736x/40/a7/41/40a741ca12a29f2ece5f37f89ef7af3c.jpg"; // Dark mode icon
    } else {
      document.body.classList.remove("dark-theme");
      themeIcon.src =
        "https://i.pinimg.com/736x/f2/24/d2/f224d2a02ad9d9beeceb244dfe1d1bc0.jpg"; // Light mode icon
    }
